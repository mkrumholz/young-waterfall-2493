...
RSpec.describe Studio do
  ...
  describe 'class methods' do
    ...
    describe '.actor_list' do
      it 'returns a list of unique, currently working actors from its movies listed by age desc' do
        expect(@studio.actor_list).to eq [@actor_4, @actor_3, @actor_5, @actor_2]
      end
    end
  end
end
